...
class PkgConfig:
    ...
    def fill_cpp_info(self, cpp_info, is_system=True, system_libs=None):
        ...
        # omnissa: Correctly parse frameworks out of linkflags for apple os
        ...
        # omnissa: We must preserve the order of requires and requires_private,
        #          as linking on linux can be order dependent.
        pc_conan_map = {}
        ...
        # omnissa: requires -> cpp_info.requires and requires_private -> cpp_info.requires_private
