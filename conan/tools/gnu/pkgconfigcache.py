...
class PkgConfigCache:
    ...
    def add_file(self, path, use_mod_version=False, system_libs=None):
        # omnissa: this cpp_info will be put into conanfile.cpp_info.components,
        #          so it should be created with set_defaults as True, providing
        #          the same behaviour as conans.model.layout.Infos
